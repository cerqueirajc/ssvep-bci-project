...
from configurations import experiment_fir_hp_tuning_correlation, experiment_fir_hp_tuning_filter
...
if __name__ == "__main__":
    ...
    experiment_parameters_list = experiment_fir_hp_tuning_correlation + experiment_fir_hp_tuning_filter 
