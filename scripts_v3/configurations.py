...
experiments_filter_short_training_1: Tuple[ExperimentParams, ...] = (
    ExperimentParams(StandardCCAFilter, kfold_1_blocks, PARAMS_CCA_SINGLE_COMPONENT, "default__3_blocks"),
    ExperimentParams(SpatioTemporalCCAFilter, kfold_1_blocks, PARAMS_SPATIO_TEMPORAL_CCA_DEFAULT, "default_ss_cca__3_blocks"),
    ExperimentParams(SpatioTemporalCCAFilter, kfold_1_blocks, PARAMS_FIR_CCA_DEFAULT, "default_fir_cca__3_blocks"),
    ExperimentParams(FilterbankCCAFilter, kfold_1_blocks, PARAMS_FILTERBANK_CCA, "default__3_blocks"),
    # ExperimentParams(FBSpatioTemporalCCAFilter, kfold_3_blocks, PARAMS_FB_SS_CCA_DEFAULT, "default_fb_ss_cca__3_blocks"),
    # ExperimentParams(FBSpatioTemporalCCAFilter, kfold_3_blocks, PARAMS_FB_FIR_CCA_DEFAULT, "default_fb_fir_cca__3_blocks"),
)
